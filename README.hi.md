...
<!-- version:start -->
**v1.22.0** — वर्तमान रिलीज़। इसमें क्या शामिल किया गया है, यह देखने के लिए [CHANGELOG.md](CHANGELOG.md) देखें।
<!-- version:end -->
...
`testing-os` आपके रिपॉजिटरी के वास्तविक परीक्षण साक्ष्यों को एआई-आधारित वर्कफ़्लो में रिकॉर्ड, सत्यापित और सीखता है। इसे किसी रिपॉजिटरी पर इंगित करें, और प्रत्येक परीक्षण रन एक साक्ष्य-पुष्टि रिकॉर्ड बन जाता है जिस पर आप भरोसा कर सकते हैं - यह स्व-रिपोर्टेड पास नहीं है।
...
- **एक पृष्ठ जो बताता है कि एक रिपॉजिटरी कैसे काम करता है।** एटलस एक रिपॉजिटरी के वर्कफ़्लो और मेनिफेस्ट को पढ़ता है, वे उपकरण जो यह चलाता है, इसकी आयात, लेखन और इतिहास, और `atlas/README.md` लिखता है: क्या आता है, क्या चलता है, यह कहां उतरता है, कौन इसे पढ़ता है, क्या क्या तोड़ता है, पिछली मानचित्र से क्या बदला है, कहां से शुरू करें। इसमें कोई भी वाक्य किसी व्यक्ति द्वारा नहीं लिखा गया है; `atlas check` तब सीआई विफल हो जाता है जब मानचित्र कोड से मेल खाना बंद कर देता है, `atlas explain <file>` उत्तर देता है कि एक फ़ाइल सिस्टम में क्या है, और प्रत्येक पुल अनुरोध को एक टिप्पणी के रूप में संरचनात्मक डेल्टा मिलता है।
...
सार्वजनिक साइट प्रत्येक सार्वजनिक रिपॉजिटरी को प्रस्तुत करती है जिसने एटलस को अपनाया है। उन रिपॉजिटरी के लिए जिन्हें आपके मशीन को नहीं छोड़ना चाहिए, समान इंजन लगातार मेमोरी के साथ एक कंटेनर के रूप में शिप किया जाता है:
...
**साक्ष्य ही प्रमाण है।** `github` सबमिशन के लिए, सत्यापनकर्ता पुष्टि करता है कि दावा किया गया GitHub क्रियाएं रन वास्तव में मौजूद है (GitHub API) और सबमिशन के `repo` और `commit_sha` को उस पुष्टि किए गए रन से जोड़ता है - एक लाइव, बिना कुंजी वाला जांच जो GitHub की अपनी ओआईडीसी पहचान में निहित है, इसलिए एक रिकॉर्ड किसी ऐसे रन या कमिट का प्रमाण नहीं दे सकता है जो नहीं हुआ। **गिटलैब सीआई** समर्थित है (`source.provider: gitlab`); एक गिटलैब सबमिशन एकमात्र मामला है जहां सत्यापनकर्ता एक गैर-GitHub होस्ट को कॉल करता है (`gitlab.com/api`), और केवल `gitlab` सबमिशन के लिए।

**रिकॉर्ड अखंडता छेड़छाड़-रोधी है, छेड़छाड़-प्रूफ नहीं।** प्रत्येक बने रहने वाले रिकॉर्ड में एक `integrity` ब्लॉक होता है (`submission_digest` + `prev_digest`) जो एक केवल-जोड़ने वाली हैश श्रृंखला बनाता है जिसे `node packages/ingest/run.js --verify-chain` पूरी तरह से ऑफ़लाइन में मान्य करता है - बैंड से बाहर छेड़छाड़, डिस्क भ्रष्टाचार और आंशिक पुनर्स्थापना का पता लगाता है। यह स्वयं इनजेस्ट क्रेडेंशियल के खिलाफ बचाव नहीं करता है, जो एक रिकॉर्ड और श्रृंखला दोनों को फिर से लिख सकता है; इसे बंद करने के लिए लेखक के नियंत्रण के बाहर एक एंकर की आवश्यकता होती है। एक **वैकल्पिक, डिफ़ॉल्ट रूप से बंद एक्सआरपीएल एंकर** (`node packages/ingest/run.js --anchor-*`) श्रृंखला के शीर्ष को सार्वजनिक एक्सआरपी लेज़र पर गवाह बनाता है, जिससे एंकर किए गए बिंदु के नीचे किसी भी संक्षिप्तीकरण या पुनर्लेखन का पता लगाया जा सकता है - गैर-GitHub कॉल, और केवल तभी जब कोई ऑपरेटर इसे सक्षम करता है।

**टेस्टिंग-ओएस किन चीज़ों को प्रभावित करता है:** प्रत्येक `repository_dispatch` पेलोड में सबमिट किया गया JSON; इस रिपॉजिटरी में `policies/`, `fixtures/`, `records/`, `indexes/` और `dogfood/roadmap/` (अंतिम केवल ऑपरेटर-द्वारा शुरू किए गए `swarm roadmap compile` द्वारा लिखा जाता है — कभी भी स्वचालित रूप से सबमिट किए गए पथ द्वारा नहीं); `api.github.com` पर आउटबाउंड कॉल, ताकि इसकी प्रामाणिकता की पुष्टि की जा सके; और — केवल `github` सबमिशन के लिए — सबमिट किए गए रिपॉजिटरी के `dogfood/scenarios/<scenario_id>.yaml` की केवल-पढ़ने योग्य फ़ेच, जो प्रमाणित कमिट पर होती है (परिदृश्य परिभाषा जो आवश्यक चरणों को लागू करती है; उपयोग से पहले आकार-सीमित और स्कीमा-मान्य, अनुपस्थित फ़ाइलें केवल उस जाँच को बिना किसी दृश्यमान चेतावनी के लागू नहीं होने देती हैं)।

**टेस्टिंग-ओएस किन चीज़ों को प्रभावित नहीं करता है:** घोषित `dogfood/scenarios/` परिभाषा फ़ाइलों से परे उपभोक्ता स्रोत कोड, उपभोक्ता रिपॉजिटरी में प्रेषण लिफ़ाफ़े से परे गुप्त जानकारी, या इस रिपॉजिटरी के कार्यक्षेत्र के बाहर कुछ भी।

**खोज-अवस्था परिवर्तन प्रमाण-आधारित होते हैं और केवल जोड़े जा सकते हैं।** स्वार्म नियंत्रण विमान के समापन क्रियाएँ (`swarm reopen`, `swarm close`) को एक स्पष्ट कारण, प्रमाण और — ऑपरेटर समापन के लिए — एक घोषित सत्यापन मोड की आवश्यकता होती है; प्रत्येक परिवर्तन एक अपरिवर्तनीय `finding_events` पंक्ति लिखता है जो कार्य करने वाले प्राधिकरण को रिकॉर्ड करता है। कोई भी स्वचालित पथ पुरानी होने पर किसी खोज को बंद नहीं कर सकता है या भविष्यवाणी के आधार पर उसे फिर से नहीं खोल सकता है, और कोई भी क्रिया घटना इतिहास को फिर से नहीं लिख सकती है — गलत तरीके से उपयोग किए गए क्रेडेंशियल परिवर्तन जोड़ सकते हैं, लेकिन प्रत्येक जोड़ स्वयं रिकॉर्ड पर होता है।

**नेटवर्क सतह।** डिफ़ॉल्ट रूप से, एकमात्र आउटगोइंग कनेक्शन `api.github.com` है (केवल-पढ़ने योग्य: प्रामाणिकता की पुष्टि + ऊपर दी गई परिदृश्य-परिभाषा फ़ेच)। दो अपवाद दोनों वैकल्पिक हैं और ऊपर बताए गए हैं: एक GitLab-प्रदाता सबमिशन (`gitlab.com/api`), और एक ऑपरेटर-सक्षम XRPL एंकर रन। **कोई टेलीमेट्री नहीं, कोई विश्लेषण नहीं — यह कोडबेस कभी भी घर नहीं भेजता है; उन दो वैकल्पिक पथों के अभाव में, यह GitHub से परे कोई नेटवर्क सतह उजागर नहीं करता है।** रिसीवर वर्कफ़्लो `contents: write` के साथ चलता है, जो केवल इस रिपॉजिटरी तक सीमित है।
...
स्वतंत्र रूप से बने रहने वाले लेकिन प्रकाशित API के माध्यम से एकीकृत होने वाले संबंधित परीक्षण उपकरण: [`shipcheck`](https://github.com/mcp-tool-shop-org/shipcheck), [`repo-knowledge`](https://github.com/mcp-tool-shop-org/repo-knowledge), [`ai-eyes-mcp`](https://github.com/mcp-tool-shop-org/ai-eyes-mcp), [`taste-engine`](https://github.com/mcp-tool-shop-org/taste-engine), [`style-dataset-lab`](https://github.com/mcp-tool-shop-org/style-dataset-lab)।
...
**समर्थित फ़ाइल सिस्टम:** APFS, HFS+, ext4 (CI आधार रेखा), NTFS — कोई भी जो POSIX `link(2)` को लागू करता है। **समर्थित नहीं:** exFAT, FAT32। [`packages/findings/lib/file-lock.js`](packages/findings/lib/file-lock.js) में फ़ाइल-लॉक CAS को परमाणु प्रकाशन के लिए हार्डलिंक सिमेंटिक्स की आवश्यकता होती है; exFAT पर, `linkSync` `ENOTSUP` फेंकता है (जोरदार, मौन नहीं)। एक सामान्य समस्या: क्रॉस-प्लेटफ़ॉर्म बाहरी SSD अक्सर exFAT में स्वरूपित होते हैं — रिपॉजिटरी को स्थानीय APFS/HFS+ पर क्लोन करें। पूर्ण सत्र G सत्यापन मैट्रिक्स के लिए [`docs/m5-validation-2026-04-29.md`](docs/m5-validation-2026-04-29.md) देखें।

## संस्करण

सभी `@dogfood-lab/*` पैकेज एक साथ अपडेट होते हैं — पूरे मोनोरेपो में एक संख्या। सात पैकेज लॉकस्टेप में `@dogfood-lab` के तहत npm पर v1.22.0 पर प्रकाशित होते हैं (`schemas`, `verify`, `report`, `ingest`, `findings`, `dogfood-swarm`, `atlas`); आठवां, `@dogfood-lab/portfolio`, आंतरिक रहता है। इस README के शीर्ष के पास संस्करण पंक्ति को प्रत्येक `npm run build` पर [`scripts/sync-version.mjs`](scripts/sync-version.mjs) के माध्यम से `package.json` से स्वचालित रूप से जोड़ा जाता है।
