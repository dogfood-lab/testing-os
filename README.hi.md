...
<!-- version:start -->
**v1.15.0** — वर्तमान रिलीज़। इसमें क्या शामिल किया गया है, यह देखने के लिए [CHANGELOG.md](CHANGELOG.md) देखें।
<!-- version:end -->
...
- **एक पृष्ठ जो बताता है कि एक रिपॉजिटरी कैसे काम करता है।** एटलस एक रिपॉजिटरी के वर्कफ़्लो और मेनिफेस्ट, वे जो उपकरण चलाते हैं, इसकी आयात, लेखन और इतिहास को पढ़ता है, और `atlas/README.md` लिखता है: क्या आता है, क्या चलता है, यह कहां उतरता है, कौन इसे पढ़ता है, क्या क्या तोड़ता है, पिछली मानचित्र से क्या बदला है, कहां से शुरू करें। इसमें कोई भी वाक्य किसी व्यक्ति द्वारा नहीं लिखा गया है; `atlas check` तब सीआई विफल हो जाता है जब मानचित्र कोड से मेल खाना बंद कर देता है, `atlas explain <file>` उत्तर देता है कि एक फ़ाइल सिस्टम में क्या है, और प्रत्येक पुल अनुरोध को एक टिप्पणी के रूप में संरचनात्मक डेल्टा प्राप्त होता है।
