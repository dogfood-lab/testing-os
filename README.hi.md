...
<!-- version:start -->
**v1.18.0** — वर्तमान रिलीज़। इसमें क्या शामिल किया गया है, यह देखने के लिए [CHANGELOG.md](CHANGELOG.md) देखें।
<!-- version:end -->
...
`testing-os` आपके रिपॉजिटरी के वास्तविक परीक्षण साक्ष्य को एआई-आधारित वर्कफ़्लो में रिकॉर्ड, सत्यापित और सीखता है। इसे किसी रिपॉजिटरी पर इंगित करें, और प्रत्येक परीक्षण रन एक साक्ष्य-पुष्टि रिकॉर्ड बन जाता है जिस पर आप भरोसा कर सकते हैं - यह स्वयं-रिपोर्ट किया गया पास नहीं है।
...
**खोज-अवस्था परिवर्तन प्रमाण-आधारित होते हैं और केवल परिशिष्ट के रूप में होते हैं।** स्वार्म नियंत्रण विमान के समापन क्रियाएँ (`swarm reopen`, `swarm close`) को एक स्पष्ट कारण, प्रमाण और — ऑपरेटर समापन के लिए — एक घोषित सत्यापन मोड की आवश्यकता होती है; प्रत्येक परिवर्तन एक अपरिवर्तनीय `finding_events` पंक्ति लिखता है जो कार्य करने वाले प्राधिकरण को रिकॉर्ड करता है। कोई भी स्वचालित पाथ पुरानी होने पर किसी खोज को बंद नहीं कर सकता है या भविष्यवाणी के आधार पर उसे फिर से नहीं खोल सकता है, और कोई भी क्रिया घटना इतिहास को फिर से नहीं लिख सकती है — गलत तरीके से उपयोग किए गए क्रेडेंशियल परिवर्तन जोड़ सकते हैं, लेकिन प्रत्येक जोड़ स्वयं रिकॉर्ड पर होता है।
...
| `@dogfood-lab/ingest` | JS | पाइपलाइन ग्लू: प्रेषण → सत्यापित करें → स्थायी रूप से संग्रहीत करें → अनुक्रमित करें। |
...
**समर्थित फ़ाइल सिस्टम:** APFS, HFS+, ext4 (CI आधार रेखा), NTFS — कोई भी जो POSIX `link(2)` को लागू करता है। **समर्थित नहीं:** exFAT, FAT32। [`packages/findings/lib/file-lock.js`](packages/findings/lib/file-lock.js) में फ़ाइल-लॉक CAS को परमाणु प्रकाशन के लिए हार्डलिंक सिमेंटिक्स की आवश्यकता होती है; exFAT पर, `linkSync` `ENOTSUP` फेंकता है (जोरदार, मौन नहीं)। सामान्य समस्या: क्रॉस-प्लेटफ़ॉर्म बाहरी SSD अक्सर exFAT में स्वरूपित होते हैं — रिपॉजिटरी को स्थानीय APFS/HFS+ में क्लोन करें। पूर्ण सत्र G सत्यापन मैट्रिक्स के लिए [`docs/m5-validation-2026-04-29.md`](docs/m5-validation-2026-04-29.md) देखें।

## संस्करण

सभी `@dogfood-lab/*` पैकेज एक साथ अपडेट होते हैं — पूरे मोनोरेपो में एक संख्या। सात पैकेज लॉकस्टेप में `@dogfood-lab` के तहत npm पर v1.18.0 पर प्रकाशित होते हैं (`schemas`, `verify`, `report`, `ingest`, `findings`, `dogfood-swarm`, `atlas`); आठवां, `@dogfood-lab/portfolio`, आंतरिक रहता है। इस README के शीर्ष के पास संस्करण पंक्ति को प्रत्येक `npm run build` पर [`scripts/sync-version.mjs`](scripts/sync-version.mjs) के माध्यम से `package.json` से स्वचालित रूप से जोड़ा जाता है।
