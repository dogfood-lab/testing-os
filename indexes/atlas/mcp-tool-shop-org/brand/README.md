...
Mapped at 2026-09-23 from commit 49c1e9d.
...
1. **CI.** On a pull request touching 16 paths; on a push touching 16 paths; or by hand. Runs scripts/check-audit-allowlist.mjs, tests/add-gallery.test.ts, tests/add-model.test.ts and 17 more; checks src/.
