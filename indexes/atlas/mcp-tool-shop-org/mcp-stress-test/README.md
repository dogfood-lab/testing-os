...
- mcp-stress (pyproject.toml) is a new command. It runs src/mcp_stress_test/cli/__init__.py.
- 134 files changed content, across 6 parts.

## What comes in

1. **CI.** On a pull request; on a push to main touching 8 paths; or by hand. Runs tests/; checks src/.
