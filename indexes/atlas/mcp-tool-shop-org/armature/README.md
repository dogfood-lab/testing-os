...
Mapped at 2026-09-25 from commit 7a70d6f.

## What this is

8 parts, mostly Python (320 files), JavaScript (2) and TypeScript (2). Work enters through 4 doors; the busiest is ci, which reaches 4 parts. It publishes to PyPI and @mcptoolshop/armature-studio to npm. People run armature.
...
- verify.ps1 is now also read by .github/workflows/ci.yml and .github/workflows/release.yml.
...
- 9 writes go to the directory the command is run in, not to this repository.
