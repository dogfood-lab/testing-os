...
3. **Publish to npm.** When a release is published; or by hand. Checks src/.
4. **Deploy site to GitHub Pages.** On a push to main touching 2 paths; or by hand. Runs no file this map can see.
