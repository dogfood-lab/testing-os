...
1. **CI.** On a pull request touching 8 paths; on a push to main touching 8 paths; or by hand. Checks packages/cli/src/, packages/kernel/src/, packages/memories/src/ and 1 more. On a push to main, it also runs site/astro.config.mjs and site/src/.
...
**Release** runs packages/cli/esbuild.config.mjs, checks packages/cli/src/, packages/kernel/src/, packages/memories/src/ and 1 more, publishes @mcptoolshop/loadout-os (packages/cli) to npm, and creates a GitHub release.
