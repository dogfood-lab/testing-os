...
describe('atlas page', () => {
  it('writes every section in order, each from the recorded facts', () => {
    ...
    const exact = {
      ...
      '## What this is': '9 parts, mostly JavaScript (12 files), HTML (1) and Python (1). Work enters through 5 doors; the busiest is Ingest, which reaches 2 parts and commits into the repository (Checks reaches 3 but commits nothing).',
