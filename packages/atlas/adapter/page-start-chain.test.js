...
describe('where to start', () => {
  it('follows the pull-request door through files that run, never a directory or a manifest, and ends in code', () => {
    ...
    assert.deepEqual(page.startHere, ['.github/workflows/ci.yml', 'test/app.test.js', 'src/app.js', 'data/out.json', 'site/view.js']);
    assert.deepEqual(section, [
      '## Where to start',
      '',
      '.github/workflows/ci.yml → test/app.test.js → src/app.js → data/out.json → site/view.js',
      '',
