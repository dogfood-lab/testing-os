...
describe('doors on the page, by the conventions of their tools', () => {
  it('names what a Python CI runs and reaches, and follows it as the busiest door', () => {
    has(py.markdown, '## What this is', '7 parts, mostly Python (10 files) and shell (1). Work enters through 5 doors; the busiest is CI, which reaches 5 parts. It publishes to PyPI and a container image.');
...
describe('the busiest door', () => {
  ...
  it('says so when no door reaches a part, rather than following one', () => {
    ...
    has(markdown, '## What this is', '7 parts, mostly Python (10 files) and shell (1). Work enters through 5 doors, and none of them runs a file this map can see. It publishes to PyPI and a container image.');
